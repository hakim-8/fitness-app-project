...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        Disclaimer: This website is a portfolio project and is not intended for real-world use. All content including contact details is fictional. The social media links direct to placeholder pages, and the map location displayed is not real.
      </Typography>
      <Stack
